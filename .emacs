...
(custom-set-variables
 ...
 '(custom-safe-themes
   (quote
    ("c1afd422fab9cb7ad2422523d0491abc8f397fea76ec57bf27c70b50bfa04243" "8eafb06bf98f69bfb86f0bfcbe773b44b465d234d4b95ed7fa882c99d365ebfd" "fc5fcb6f1f1c1bc01305694c59a1a861b008c534cae8d0e48e4d5e81ad718bc6" "1e7e097ec8cb1f8c3a912d7e1e0331caeed49fef6cff220be63bd2a6ba4cc365" default)))
 '(ede-project-directories (quote ("/Users/adamcchampion/Teaching/CSE2431/lab1")))
 '(enscript-after-hook
   (quote
    ((lambda nil
       (when preview-file
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :background "#042028" :foreground "#708183" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 160 :width normal :foundry "nil" :family "Hack"))))
 '(aquamacs-variable-width ((t (:stipple nil :strike-through nil :underline nil :slant normal :weight normal :height 150 :width normal :family "Hack"))) t)
 '(echo-area ((t (:stipple nil :strike-through nil :underline nil :slant normal :weight normal :width normal :family "Hack"))) t)
 ...
 '(font-lock-comment-delimiter-face ((t (:foreground "##9ca7a7" :inverse-video nil :underline nil :slant italic :weight normal))))
 '(font-lock-comment-face ((t (:foreground "#9ca7a7" :inverse-video nil :underline nil :slant italic :weight normal))))
 '(font-lock-constant-face ((t (:foreground "#660E7A" :slant italic :weight bold))))
 '(font-lock-function-name-face ((t (:foreground "black"))))
 '(font-lock-keyword-face ((t (:foreground "#000080" :weight bold))))
 ...
 '(latex-mode-default ((t (:inherit autoface-default :stipple nil :strike-through nil :underline nil :slant normal :weight normal :height 150 :width normal :family "Hack"))) t)
 ...
 '(tooltip ((t (:inherit variable-pitch :background "FloralWhite" :foreground "black"))))
